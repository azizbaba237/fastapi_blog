...
import models 
from schema import PostCreate, PostResponse, UserCreate, UserResponse, PostUpdate
...
def get_post(post_id: int, db: Annotated[Session, Depends(get_db)]):
 ...
 # update a post completly by id


# Update full post by id
